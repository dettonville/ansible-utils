...
$ cd ${REPO_DIR}
$
$ env ANSIBLE_NOCOLOR=True ansible-doc -t filter dettonville.utils.ldif | tee /Users/ljohnson/repos/ansible/ansible_collections/dettonville/utils/docs/ldif.md
> FILTER dettonville.utils.ldif (/Users/ljohnson/tmp/_DcjK8N/ansible_collections/dettonville/utils/plugins/filter/ldif.py)
  ...
  at 76 characters).
  Converts properly formatted LDIF records back into native Python
  dictionaries, automatically handling line continuations.
