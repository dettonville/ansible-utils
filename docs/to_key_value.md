...
| **quote_char**<br>`str` | Default: `"\""` | The character used for quoting values when M(quote) is enabled. |
...
> FILTER dettonville.utils.to_key_value (/var/folders/w6/3rcdpp211v5cxml6vg45ww3r0000gn/T/ansible_doc_cowvjbd9/ansible_collections/dettonville/utils/plugins/filter/to_key_value.py)
