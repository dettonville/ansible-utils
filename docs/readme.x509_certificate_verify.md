...
| `content`             | Base64 encoded certificate content (PEM or DER format).                                                                                         | String  | No       | -       |
...
| `chain_path`          | (Deprecated, use `ca_path`) Path to a file containing intermediate certificates (PEM or DER format) to build the certificate chain for verification. | Path    | No       | -       |
