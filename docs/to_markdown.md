...
> **Note:** The compiled HTML documentation for this filter is available at: [https://dettonville.github.io/ansible-utils/to_markdown_filter.html](https://dettonville.github.io/ansible-utils/to_markdown_filter.html)
...
| :--- | :--- | :--- |
| **_input**<br>`any / **required**` |  | The data to convert to Markdown. |
| **flatten_nested**<br>`bool` | Default: `true` | Whether to flatten nested dicts. |
...
| :--- | :--- | :--- |
| **_value**<br>`(str)` | always | Markdown formatted string representing the input data. |
...
> FILTER dettonville.utils.to_markdown (/var/folders/w6/3rcdpp211v5cxml6vg45ww3r0000gn/T/ansible_doc_5lnnyiz3/ansible_collections/dettonville/utils/plugins/filter/to_markdown.py)
