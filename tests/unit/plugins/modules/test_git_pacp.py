...
class TestGitActions(unittest.TestCase):
    ...
    def test_clone(self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp):
        ...
        self.mock_module.run_command.return_value = (0, "Cloning into repo...", "")
    ...
    def test_pull(self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp):
        ...
        self.mock_module.run_command.return_value = (0, "Already up to date.", "")
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_set_user_config(self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp):
    ...
    def test_ssh_params_initialization(
        ...
        repo_config["repo_url"] = "ssh://git@bitbucket.example.org:2222/test/repo.git"
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_git_version(self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp):
        ...
        self.mock_module.run_command.return_value = (0, "git version 2.34.1", "")
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_get_branches(self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp):
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_get_annotated_tags(self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp):
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_write_ssh_wrapper_content(
        self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp
    ):
        ...
        ssh_params = {"key_file": "~/.ssh/id_rsa", "accept_hostkey": True}

        repo_config = self.repo_config.copy()
        repo_config["repo_url"] = "ssh://git@bitbucket.example.org:2222/test/repo.git"
        repo_config["ssh_params"] = ssh_params

        Git(self.mock_module, repo_config)
...
class TestGitActionsErrorHandling(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures"""
        self.mock_module = Mock(spec=AnsibleModule)
        self.mock_module.params = {"executable": None, "logging_level": "DEBUG"}
        self.mock_module.tmpdir = "/tmp/ansible"
        self.mock_module.get_bin_path.return_value = "/usr/bin/git"
        self.mock_module.add_cleanup_file = Mock()
        self.mock_module.fail_json = Mock()
        ...
        self.repo_config_ssh = {
            "repo_url": "ssh://git@bitbucket.example.org:2222/test/repo.git",
            "repo_dir": "/tmp/test_repo",
            "repo_branch": "main",
            "ssh_params": {
                "accept_hostkey": "true",
    ...
    #         Git(self.mock_module, self.repo_config_https)
    #
    # @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.tempfile.mkstemp"))
    # @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.fdopen"))
    # @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    ...
    #     mock_stat.return_value = Mock(st_mode=0o644)
    #
    #     git = Git(self.mock_module, self.repo_config_https)
    #
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_push_remote_add_failure(
        self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp
    ):
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_set_user_config_failure(
        self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp
    ):
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_ssh_wrapper_creation_failure(
        self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp
    ):
        ...
        with self.assertRaises(OSError):
            Git(self.mock_module, self.repo_config_ssh)

    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.tempfile.mkstemp"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.fdopen"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_ssh_wrapper_write_failure(
        self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp
    ):
    ...
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.stat"))
    @patch(make_absolute(MODULE_UTILS_IMPORT_PATH, "git_actions.os.chmod"))
    def test_ssh_wrapper_chmod_failure(
        self, mock_chmod, mock_stat, mock_fdopen, mock_mkstemp
    ):
