...
| [sort_dict_list](https://github.com/dettonville/ansible-utils/blob/main/plugins/filter/sort_dict_list.py)                   | Sort list of dicts using specified sort key(s).                                                                              |
...
| [to_ldif](https://github.com/dettonville/ansible-utils/blob/main/plugins/filter/ldif.py)                                    | Convert dictionary to LDIF format.                                                                                           |
| [to_markdown](https://github.com/dettonville/ansible-utils/blob/main/plugins/filter/to_markdown.py)                         | Convert list of flat dictionaries to markdown format.                                                                        |
...
| [to_key_value](https://github.com/dettonville/ansible-utils/blob/main/plugins/filter/to_key_value.py)                       | Convert list of flat dictionaries to key=value format.                                                                       |

### Modules
| Name                                                                                                                         | Description                                                                                       |
|------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| [export_dicts](https://github.com/dettonville/ansible-utils/blob/main/plugins/modules/export_dicts.py)                       | Export list of dicts to markdown or csv formatted file.                                           |
...
| [htpasswd](https://github.com/dettonville/ansible-utils/blob/main/plugins/modules/htpasswd.py)                               | Manage single or multiple user credentials in an htpasswd file with backup and overwrite support. |
